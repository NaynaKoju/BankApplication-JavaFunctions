...
import com.mycompany.controller.AccountHandler;
import com.mycompany.controller.UserHandler;
...
public class MainView {
 ...
 System.out.println("Accounnt created sucessfully");
    ...
    public static void depositAmountView(){
       ...
       if(ah.depositAmount(accountNumber,depositBalance)){
    ...
    public static void withdrawAmountView(){
        ...
        if (ah.withdrawAmount(accountNumber,withdrawAmount)){
    ...
    public static void transferAmountView(){
        ...
        if(ah.transferAmount(senderaccountNumber, recieveraccountNumber, transferAmount)){
